"""
(c)Constants and variables for use throughout the project.  Includes GPIO pin numbers, IP addresses, hardware addresses, and more. 
"""
...
# client.py
HOST = "10.49.99.91"  # pink
# HOST = "10.49.41.8"   #yellow
COMMAND_PORT = 65432
