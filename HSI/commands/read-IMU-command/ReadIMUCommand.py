...
class ReadIMUCommand(CommandInterface):
            ...
            try:            
                ...
                try:
                    ...
                    if(sensor_return != -1):
                        ...
                        logging.error('ReadIMUCommand : IMU reading return error')
    ...
    def execute(self, responseStatusCallback, jsonObject):
        try:
            t1 = threading.Thread(target=self._readIMUHelper, args=(responseStatusCallback, jsonObject,))
            t1.start()
        except:
